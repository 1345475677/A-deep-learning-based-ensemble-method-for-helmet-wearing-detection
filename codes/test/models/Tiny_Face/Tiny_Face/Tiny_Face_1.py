...
def evaluate(weight_file_path, data_dir, output_dir, prob_thresh=0.5, nms_thresh=0.1, lw=3, display=False):
  ...
  with tf.Session() as sess:
    ...
    for filename in filenames:
      ...
      df.to_csv("test_result_face.csv",index=False,header=False,mode="a+")
...
def main():
  ...
  with tf.Graph().as_default():
    evaluate(weight_file_path='D:/anaconda\models/research\Tiny_Face/mat2tf.pkl', data_dir='ata/test/new_test', output_dir='data/test_results')
