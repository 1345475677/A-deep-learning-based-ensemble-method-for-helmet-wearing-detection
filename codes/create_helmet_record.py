  ...
  if 'object' in data :
      for obj in data['object']:
        if obj:
          ...
          if class_name in label_map_dict.keys():#防止除了person和dog以外的物体参与训练
...
#  label_map_dict = label_map_util.get_label_map_dict(FLAGS.label_map_path)
  label_map_dict = label_map_util.get_label_map_dict('D:\\anaconda\models/research\object_detection/training/helmet_label_map.pbtxt')
...
#  examples_list = dataset_util.read_examples_list(examples_path)
  ...
  # our own split.
  random.seed(42)
  random.shuffle(examples_list)#将文件名随机排列
